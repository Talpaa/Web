...
const RegistrationScreen = ({ navigation }) => {
  ...
  const validateForm = () => {
    ...
    if (!formData.emailConfirm.trim()) {
        newErrors.emailConfirm = "La conferma dell'email è obbligatoria";
        isValid = false;
    ...
    <ScrollView style={styles.container}>
      <View style={styles.formContainer}>
        ...
        <View style={styles.inputGroup}>
            ...
            <TextInput
                style={[styles.input, errors.emailConfirm && styles.inputError]}
                value={formData.emailConfirm}
                onChangeText={(text) => setFormData({ ...formData, emailConfirm: text })}
                placeholder="Reinserisci la tua email"
                keyboardType="email-address"
                autoCapitalize="none"
            />
            {errors.emailConfirm && <Text style={styles.errorText}>{errors.emailConfirm}</Text>}
        </View>
